			...
			<div className='bg-milk-500'>
				<div className='relative top-16'>
					<video
						...
						controls={false}
					>
						<source src='/assets/mixkit-1.mp4' type='video/mp4' />
						Ваш браузер не поддерживает видео.
					</video>
					<div className='absolute inset-0 bg-wave-500/10 flex items-center justify-center'>
						<img
				...
				<div className='bg-milk-500 sm:py-2'>
					<div className='mx-auto max-w-2xl pt-16 px-6 lg:max-w-7xl lg:px-8'>
						...
						<div className='relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] lg:rounded-l-[calc(2rem+1px)]'>
							<div className='px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0'>
								<p className='mt-2 max-w-lg font-display text-md/6 text-wave-500/70 max-lg:text-center'>
									...
									колыбель великих открытий. Здесь у берегов Балтики, начинались
									легендарные экспедиции, изменившие карту мира. Крузенштерн,
									Лисянский, Беллинсгаузен, Лазарев - их корабли уходили в
									неизведанное, открывая новые земли и укрепляя славу русского
									флота. 41 кругосветное плавание - наша история (в 1820 году
						...
						<div className='relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]'>
							<div className='px-8 pt-8 sm:px-10 sm:pt-10'>
								<p className='mt-2 max-w-lg font-display text-md/6 text-wave-500/70 max-lg:text-center'>
									...
									вступить в новый этап пути, где стихия проверяла на прочность,
									а ветры перемен вели к неизведанным берегам. Через него лежал
									путь в Индию, Азию и к тайнам Южных морей.
								</p>
							</div>
						...
						<div className='relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)]'>
							<div className='px-8 pt-8 sm:px-10 sm:pt-10'>
								<p className='mt-2 max-w-lg font-display text-md/6 text-wave-500/70 max-lg:text-center'>
									...
									с таким названием, ходила легенда, что, после шумных вечеров,
									некоторые гости, как корабли в бурю, "бросали якорь" у порога,
									отложив возвращение до рассвета. Так родилась поговорка:
									"Потерпел крушение у Мыса Доброй Надежды" - в ней смешались
									морская романтика, самоирония и дух авантюры.
								</p>
							</div>
							<div className='flex flex-1 items-center justify-center px-8 max-lg:pt-10 max-lg:pb-12 sm:px-10 lg:pb-2'>
								<div className='w-full max-lg:max-w-xs overflow-hidden rounded-lg lg:rounded-xl'>
					...
					<div className='relative lg:row-span-2'>
						...
						<div className='relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]'>
							<div className='px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0'>
								<p className='mt-2 max-w-lg font-display text-md/6 text-wave-500/70 max-lg:text-center'>
									<span className='text-md font-medium tracking-tight text-wave-500'>
										Мы предлагаем Вам отправиться в гастрономическое путешествие
										-&nbsp;
									</span>
									сквозь океаны и эпохи к лучшим вкусам континентов. В меню
									предлагаем блюда мировой кухни, от пряных нот Азии до
									средиземноморской гармонии, от сытной европейской классики до
									экзотики Южных морей. Атмосфера уюта, словно капитанская каюта
									после долгого плавания, согреет теплом дерева, мягким светом
									фонарей и шепотом старых карт.
								</p>
							</div>
