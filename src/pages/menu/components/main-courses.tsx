...
function MainCourses() {
	const [selectedMainCourse, setSelectedMainCourse] = useState<MenuItem | null>(
		null
	)
	const [isDrawerOpen, setIsDrawerOpen] = useState<boolean>(false)

	const openDrawer = (mainCourse: MenuItem) => {
