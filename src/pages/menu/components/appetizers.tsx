...
function Appetizers() {
	const [selectedAppetizer, setSelectedAppetizer] = useState<MenuItem | null>(
		null
	)
	const [isDrawerOpen, setIsDrawerOpen] = useState<boolean>(false)

	const openDrawer = (appetizer: MenuItem) => {
