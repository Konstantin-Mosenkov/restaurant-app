...
import { dumplings } from '../data'

function Dumplings() {
	const [selectedDumpling, setSelectedDumpling] = useState<MenuItem | null>(
		null
	)
	const [isDrawerOpen, setIsDrawerOpen] = useState<boolean>(false)

	const openDrawer = (dumpling: MenuItem) => {
